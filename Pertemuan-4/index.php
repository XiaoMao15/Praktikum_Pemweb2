...
<body>
    <div class="container">
        <h2>Selamat Datang di Perpustakaan Astral Express</h2>
    ...
    <div class="form-group row">
        ...
        <div class="input-group">
            ...
            <input id="fullname" name="fullname" placeholder="Nama Lengkap Diisi" type="text" required="required" class="form-control">
        </div>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="input-group">
            ...
            <input id="email" name="email" placeholder="Isi Email" type="text" required="required" class="form-control">
        </div>
        </div>
    </div>
    <div class="form-group row">
